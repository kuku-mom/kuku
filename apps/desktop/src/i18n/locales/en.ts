...
export const EN_MESSAGES = {
  ...
  "settings.plugin.sync.action.copy_diagnostics": "Copy diagnostics",
  "settings.plugin.sync.action.diagnostics_copied": "Diagnostics copied",
  ...
  "settings.plugin.sync.metrics.review_items": "Review items",
  ...
  "settings.plugin.sync.review.title": "Sync Review",
  "settings.plugin.sync.review.description":
    "Items that need a decision before sync can finish safely.",
  "settings.plugin.sync.review.empty": "No review items are waiting.",
  "settings.plugin.sync.review.kind.import": "Import",
  "settings.plugin.sync.review.kind.projection_blocked": "Blocked write",
  "settings.plugin.sync.review.kind.conflict": "Conflict",
  "settings.plugin.sync.review.kind.missing_object": "Missing object",
  "settings.plugin.sync.review.open_diff": "Diff",
  "settings.plugin.sync.review.accept_import": "Accept",
  "settings.plugin.sync.review.reject_import": "Reject",
  "settings.plugin.sync.review.keep_delete": "Keep delete",
  "settings.plugin.sync.review.restore_edited": "Restore edit",
  "settings.plugin.sync.review.rename": "Rename",
  "settings.plugin.sync.review.rename_placeholder": "New path",
  "settings.plugin.sync.review.rename_required": "Enter a path before renaming.",
  "settings.plugin.sync.review.save_rename": "Save",
  "settings.plugin.sync.review.cancel": "Cancel",
  "settings.plugin.sync.review.retry": "Retry",
  "settings.plugin.sync.review.restore_snapshot": "Restore",
  "settings.plugin.sync.review.restore_placeholder": "Restore path",
  "settings.plugin.sync.review.restore_path_required": "Enter a path before restoring.",
  "settings.plugin.sync.review.restore_save": "Restore",
  "settings.plugin.sync.review.restore_failed": "Could not restore the snapshot.",
  "settings.plugin.sync.review.recovery_load_failed": "Could not load recovery snapshots.",
  "settings.plugin.sync.review.recovery_unavailable": "Some recovery data is unavailable.",
  "settings.plugin.sync.review.recovery_kind.current": "Current",
  "settings.plugin.sync.review.recovery_kind.tombstone": "Deleted",
  "settings.plugin.sync.review.recovery_kind.delete_edit_tombstone": "Deleted version",
  "settings.plugin.sync.review.recovery_kind.delete_edit_current": "Edited version",
  "settings.plugin.sync.review.open_failed": "Could not open the review diff.",
  "settings.plugin.sync.review.resolve_failed": "Could not resolve the review item.",
