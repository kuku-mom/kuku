...
export const EN_MESSAGES = {
  ...
  "vault.folder_agent.ask": "Ask this folder",
  "vault.folder_agent.context": "Show folder context",
  "vault.folder_agent.next": "Next steps",
  "vault.folder_agent.handoff": "Create Codex handoff proposal",
  "vault.folder_agent.scaffold": "Set up Folder Agent files",
  "vault.folder_agent.needs_setup": "Folder Agent setup incomplete",
  "vault.folder_agent.ready": "Folder Agent files ready",
  ...
  "chat.scope.select": "Chat scope",
  "chat.scope.vault": "Vault",
  "chat.scope.vault_hint": "All notes",
  "chat.scope.no_folders": "No first-level folders",
  "chat.scope.folder_ready": "Folder Agent ready",
  "chat.scope.folder_missing_setup": "Setup files missing",
  "chat.approval.project_manual_review":
    "Folder Agent memory proposals always require manual review before they are applied.",
  "chat.folder_overview.ready": "Folder Agent files are ready",
  "chat.folder_overview.needs_setup": "Some Folder Agent files are missing",
  "chat.folder_overview.decisions": "Decisions",
  "chat.folder_overview.meetings": "Meetings",
  "chat.folder_overview.proposals": "Proposals",
  "chat.folder_overview.action.summary": "Status summary",
  "chat.folder_overview.action.next": "Next actions",
  "chat.folder_overview.action.handoff": "Codex handoff",
  "chat.folder_overview.action.scaffold": "Set up files",
  ...
  "tool.project_list.label": "List Folder Agents",
  "tool.project_list.active": "Listing folders",
  "tool.project_list.description":
    "Lists first-level vault folders and their Folder Agent setup status.",
  "tool.project_context.label": "Folder Context",
  "tool.project_context.active": "Reading folder context",
  "tool.project_context.description":
    "Assembles PROJECT, NEXT, AGENTS, decisions, and meetings for the selected folder.",
  "tool.project_next_steps.label": "Read Next Steps",
  "tool.project_next_steps.active": "Reading next steps",
  "tool.project_next_steps.description": "Reads NEXT.md for the selected Folder Agent folder.",
  "tool.project_propose_agent_handoff.label": "Propose Agent Handoff",
  "tool.project_propose_agent_handoff.active": "Drafting handoff",
  "tool.project_propose_agent_handoff.description":
    "Creates a reviewable handoff proposal for Codex or another agent.",
  "tool.project_propose_scaffold.label": "Propose Folder Setup",
  "tool.project_propose_scaffold.active": "Drafting setup",
  "tool.project_propose_scaffold.description":
    "Proposes missing PROJECT, NEXT, AGENTS, and memory folders for review.",
  "tool.project_propose_next_steps.label": "Propose Next Steps",
  "tool.project_propose_next_steps.active": "Drafting NEXT",
  "tool.project_propose_next_steps.description":
    "Proposes a reviewed create or replacement for NEXT.md.",
  "tool.project_propose_decision.label": "Propose Decision",
  "tool.project_propose_decision.active": "Drafting decision",
  "tool.project_propose_decision.description":
    "Proposes a reviewed decision note for the selected folder.",
  "tool.project_propose_meeting_summary.label": "Propose Meeting Summary",
  "tool.project_propose_meeting_summary.active": "Drafting meeting summary",
  "tool.project_propose_meeting_summary.description":
    "Proposes a reviewed meeting summary for the selected folder.",
