...
export const JA_MESSAGES = {
  ...
  "settings.plugin.ai_chat.agents.title": "外部エージェント",
  "settings.plugin.ai_chat.agents.description":
    "Kuku Agent と並べて使う ACP 対応コマンドラインエージェントを設定します。",
  "settings.plugin.ai_chat.agents.enabled": "有効",
  "settings.plugin.ai_chat.agents.disabled": "無効",
  "settings.plugin.ai_chat.agents.command": "コマンド",
  "settings.plugin.ai_chat.agents.args": "引数",
  "settings.plugin.ai_chat.agents.env": "環境変数",
  "settings.plugin.ai_chat.agents.args_empty": "(引数なし)",
  "settings.plugin.ai_chat.agents.empty": "外部エージェントはまだ設定されていません。",
  ...
  "status_bar.update.title": "アップデート",
  "status_bar.update.idle": "利用可能な更新はありません",
  "status_bar.update.checking": "更新を確認中",
  "status_bar.update.available": "{{version}} が利用可能です",
  "status_bar.update.downloading": "{{progress}}% ダウンロード中",
  "status_bar.update.ready": "再起動の準備ができました",
  "status_bar.update.error": "更新確認に失敗しました",
  "status_bar.update.check": "確認",
  ...
  "chat.header.close_session": "セッションを閉じる",
  "chat.header.new_session": "新しいセッション",
  "chat.header.session_select": "チャットセッションを切り替え",
  "chat.agent_selector.select": "AIエージェントを選択",
  "chat.agent_selector.external_agents": "外部エージェント",
  "chat.agent_selector.not_configured": "未設定",
  "chat.agent_selector.add_more_agents": "エージェントを追加",
