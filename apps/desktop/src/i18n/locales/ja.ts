...
export const JA_MESSAGES = {
  ...
  "vault.folder_agent.ask": "このフォルダーに質問",
  "vault.folder_agent.context": "フォルダー文脈を表示",
  "vault.folder_agent.next": "次のアクション",
  "vault.folder_agent.handoff": "Codex引き継ぎ提案を作成",
  "vault.folder_agent.scaffold": "Folder Agentファイルを設定",
  "vault.folder_agent.needs_setup": "Folder Agent設定が未完了です",
  "vault.folder_agent.ready": "Folder Agentファイル準備完了",
  ...
  "chat.scope.select": "チャット範囲",
  "chat.scope.vault": "ボルト",
  "chat.scope.vault_hint": "すべてのノート",
  "chat.scope.no_folders": "1階層目のフォルダーがありません",
  "chat.scope.folder_ready": "Folder Agent準備完了",
  "chat.scope.folder_missing_setup": "設定ファイルが不足",
  "chat.approval.project_manual_review":
    "Folder Agent memory提案は、自動承認がオンでも必ず手動レビュー後に適用されます。",
  "chat.folder_overview.ready": "Folder Agentファイルは準備済みです",
  "chat.folder_overview.needs_setup": "一部のFolder Agentファイルが不足しています",
  "chat.folder_overview.decisions": "決定",
  "chat.folder_overview.meetings": "会議",
  "chat.folder_overview.proposals": "提案",
  "chat.folder_overview.action.summary": "状態要約",
  "chat.folder_overview.action.next": "次のアクション",
  "chat.folder_overview.action.handoff": "Codex引き継ぎ",
  "chat.folder_overview.action.scaffold": "ファイル設定",
  ...
  "tool.project_list.label": "Folder Agent一覧",
  "tool.project_list.active": "フォルダー確認中",
  "tool.project_list.description": "1階層目のフォルダーとFolder Agent設定状態を確認します。",
  "tool.project_context.label": "フォルダー文脈",
  "tool.project_context.active": "フォルダー文脈を読み込み中",
  "tool.project_context.description":
    "選択フォルダーのPROJECT、NEXT、AGENTS、決定、会議文脈をまとめます。",
  "tool.project_next_steps.label": "次のアクションを読む",
  "tool.project_next_steps.active": "次のアクションを読み込み中",
  "tool.project_next_steps.description": "選択したFolder AgentフォルダーのNEXT.mdを読みます。",
  "tool.project_propose_agent_handoff.label": "エージェント引き継ぎ提案",
  "tool.project_propose_agent_handoff.active": "引き継ぎ案を作成中",
  "tool.project_propose_agent_handoff.description":
    "Codexや他のエージェント向けのレビュー可能な引き継ぎ提案を作成します。",
  "tool.project_propose_scaffold.label": "フォルダー設定提案",
  "tool.project_propose_scaffold.active": "設定案を作成中",
  "tool.project_propose_scaffold.description":
    "不足しているPROJECT、NEXT、AGENTSとmemoryフォルダーをレビュー用に提案します。",
  "tool.project_propose_next_steps.label": "次のアクション提案",
  "tool.project_propose_next_steps.active": "NEXTを作成中",
  "tool.project_propose_next_steps.description":
    "NEXT.mdの作成または置換をレビュー用変更として提案します。",
  "tool.project_propose_decision.label": "決定提案",
  "tool.project_propose_decision.active": "決定を作成中",
  "tool.project_propose_decision.description": "選択フォルダーの決定ノートをレビュー用に提案します。",
  "tool.project_propose_meeting_summary.label": "会議要約提案",
  "tool.project_propose_meeting_summary.active": "会議要約を作成中",
  "tool.project_propose_meeting_summary.description":
    "選択フォルダーの会議要約ノートをレビュー用に提案します。",
