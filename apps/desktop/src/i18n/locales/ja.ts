...
export const JA_MESSAGES = {
  ...
  "settings.plugin.sync.action.copy_diagnostics": "診断をコピー",
  "settings.plugin.sync.action.diagnostics_copied": "診断をコピーしました",
  ...
  "settings.plugin.sync.metrics.review_items": "レビュー項目",
  ...
  "settings.plugin.sync.review.title": "同期レビュー",
  "settings.plugin.sync.review.description":
    "同期を安全に完了する前に判断が必要な項目です。",
  "settings.plugin.sync.review.empty": "レビュー待ちの項目はありません。",
  "settings.plugin.sync.review.kind.import": "取り込み",
  "settings.plugin.sync.review.kind.projection_blocked": "書き込みブロック",
  "settings.plugin.sync.review.kind.conflict": "競合",
  "settings.plugin.sync.review.kind.missing_object": "不足オブジェクト",
  "settings.plugin.sync.review.open_diff": "Diff",
  "settings.plugin.sync.review.accept_import": "承認",
  "settings.plugin.sync.review.reject_import": "拒否",
  "settings.plugin.sync.review.keep_delete": "削除を保持",
  "settings.plugin.sync.review.restore_edited": "編集を復元",
  "settings.plugin.sync.review.rename": "名前を変更",
  "settings.plugin.sync.review.rename_placeholder": "新しいパス",
  "settings.plugin.sync.review.rename_required": "名前を変更する前にパスを入力してください。",
  "settings.plugin.sync.review.save_rename": "保存",
  "settings.plugin.sync.review.cancel": "キャンセル",
  "settings.plugin.sync.review.retry": "再試行",
  "settings.plugin.sync.review.restore_snapshot": "復元",
  "settings.plugin.sync.review.restore_placeholder": "復元先パス",
  "settings.plugin.sync.review.restore_path_required": "復元する前にパスを入力してください。",
  "settings.plugin.sync.review.restore_save": "復元",
  "settings.plugin.sync.review.restore_failed": "スナップショットを復元できませんでした。",
  "settings.plugin.sync.review.recovery_load_failed": "復元スナップショットを読み込めませんでした。",
  "settings.plugin.sync.review.recovery_unavailable": "一部の復元データを利用できません。",
  "settings.plugin.sync.review.recovery_kind.current": "現在",
  "settings.plugin.sync.review.recovery_kind.tombstone": "削除済み",
  "settings.plugin.sync.review.recovery_kind.delete_edit_tombstone": "削除時点",
  "settings.plugin.sync.review.recovery_kind.delete_edit_current": "編集版",
  "settings.plugin.sync.review.open_failed": "レビュー diff を開けませんでした。",
  "settings.plugin.sync.review.resolve_failed": "レビュー項目を解決できませんでした。",
