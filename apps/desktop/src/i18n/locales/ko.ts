...
export const KO_MESSAGES = {
  ...
  "settings.plugin.sync.action.copy_diagnostics": "진단 복사",
  "settings.plugin.sync.action.diagnostics_copied": "진단을 복사했어요",
  ...
  "settings.plugin.sync.metrics.review_items": "검토 항목",
  ...
  "settings.plugin.sync.review.title": "동기화 검토",
  "settings.plugin.sync.review.description":
    "동기화를 안전하게 완료하기 전에 결정이 필요한 항목이에요.",
  "settings.plugin.sync.review.empty": "대기 중인 검토 항목이 없어요.",
  "settings.plugin.sync.review.kind.import": "가져오기",
  "settings.plugin.sync.review.kind.projection_blocked": "쓰기 차단",
  "settings.plugin.sync.review.kind.conflict": "충돌",
  "settings.plugin.sync.review.kind.missing_object": "누락 객체",
  "settings.plugin.sync.review.open_diff": "Diff",
  "settings.plugin.sync.review.accept_import": "수락",
  "settings.plugin.sync.review.reject_import": "거절",
  "settings.plugin.sync.review.keep_delete": "삭제 유지",
  "settings.plugin.sync.review.restore_edited": "수정본 복구",
  "settings.plugin.sync.review.rename": "이름 변경",
  "settings.plugin.sync.review.rename_placeholder": "새 경로",
  "settings.plugin.sync.review.rename_required": "이름을 변경하기 전에 경로를 입력해 주세요.",
  "settings.plugin.sync.review.save_rename": "저장",
  "settings.plugin.sync.review.cancel": "취소",
  "settings.plugin.sync.review.retry": "재시도",
  "settings.plugin.sync.review.restore_snapshot": "복원",
  "settings.plugin.sync.review.restore_placeholder": "복원 경로",
  "settings.plugin.sync.review.restore_path_required": "복원하기 전에 경로를 입력해 주세요.",
  "settings.plugin.sync.review.restore_save": "복원",
  "settings.plugin.sync.review.restore_failed": "스냅샷을 복원할 수 없어요.",
  "settings.plugin.sync.review.recovery_load_failed": "복구 스냅샷을 불러올 수 없어요.",
  "settings.plugin.sync.review.recovery_unavailable": "일부 복구 데이터를 사용할 수 없어요.",
  "settings.plugin.sync.review.recovery_kind.current": "현재 버전",
  "settings.plugin.sync.review.recovery_kind.tombstone": "삭제된 버전",
  "settings.plugin.sync.review.recovery_kind.delete_edit_tombstone": "삭제 시점",
  "settings.plugin.sync.review.recovery_kind.delete_edit_current": "수정본",
  "settings.plugin.sync.review.open_failed": "검토 diff를 열 수 없어요.",
  "settings.plugin.sync.review.resolve_failed": "검토 항목을 해결할 수 없어요.",
