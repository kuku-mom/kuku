...
export const KO_MESSAGES = {
  ...
  "settings.appearance.theme.description": "앱과 에디터에 어울리는 글쓰기용 테마를 골라 주세요.",
  ...
  "settings.appearance.theme.github": "GitHub",
  "settings.appearance.theme.vue": "Vue",
  "settings.appearance.theme.notion": "Notion",
