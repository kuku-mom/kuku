...
export const KO_MESSAGES = {
  ...
  "settings.plugin.ai_chat.agents.title": "외부 에이전트",
  "settings.plugin.ai_chat.agents.description":
    "Kuku Agent와 함께 사용할 ACP 호환 커맨드라인 에이전트를 설정해요.",
  "settings.plugin.ai_chat.agents.enabled": "켜짐",
  "settings.plugin.ai_chat.agents.disabled": "꺼짐",
  "settings.plugin.ai_chat.agents.command": "명령",
  "settings.plugin.ai_chat.agents.args": "인자",
  "settings.plugin.ai_chat.agents.env": "환경 변수",
  "settings.plugin.ai_chat.agents.args_empty": "(인자 없음)",
  "settings.plugin.ai_chat.agents.empty": "아직 설정된 외부 에이전트가 없어요.",
  ...
  "status_bar.update.title": "업데이트",
  "status_bar.update.idle": "사용 가능한 업데이트 없음",
  "status_bar.update.checking": "업데이트 확인 중",
  "status_bar.update.available": "{{version}} 사용 가능",
  "status_bar.update.downloading": "{{progress}}% 다운로드 중",
  "status_bar.update.ready": "다시 실행 준비됨",
  "status_bar.update.error": "업데이트 확인 실패",
  "status_bar.update.check": "확인",
  ...
  "chat.header.close_session": "세션 닫기",
  "chat.header.new_session": "새 세션",
  "chat.header.session_select": "채팅 세션 전환",
  "chat.agent_selector.select": "AI 에이전트 선택",
  "chat.agent_selector.external_agents": "외부 에이전트",
  "chat.agent_selector.not_configured": "설정되지 않음",
  "chat.agent_selector.add_more_agents": "에이전트 더 추가",
  ...
  "chat.welcome.s1.prompt": "이 문서와 관련된 노트를 찾아서 서로 어떻게 연결되는지 보여줘",
  "chat.welcome.s2.text": "핵심 인사이트 추출",
  "chat.welcome.s2.hint": "핵심을 요약하고 다음에 볼 내용을 제안해요",
  "chat.welcome.s2.prompt": "이 문서를 핵심만 명확하게 요약하고 이어서 볼 질문을 제안해줘",
  "chat.welcome.s3.text": "새 아이디어 합성",
  "chat.welcome.s3.hint": "흩어진 생각을 연결된 노트로 확장해요",
  "chat.welcome.s3.prompt": "원본 문서를 바탕으로 기존 노트와 연결되는 wiki 초안을 만들어줘",
  "chat.welcome.s4.text": "지식보관함 정리하기",
  "chat.welcome.s4.hint": "미연결 노트를 찾아 연결을 제안해요",
  "chat.welcome.s4.prompt": "지식보관함에서 연결되지 않은 노트를 검토하고 추가할 링크를 제안해줘",
